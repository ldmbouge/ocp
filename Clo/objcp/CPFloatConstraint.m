...
void ulp_computation_f(mpri_t ulp, const float_interval f){
...
-(void) propagate
{
    ...
    NSLog(@"x %16.16e: %s %16.16e: %s", [_x minErrF], mpq_get_str(NULL, 10, *[_x minErr]), [_x maxErrF], mpq_get_str(NULL, 10, *[_x maxErr]));
    NSLog(@"y %16.16e: %s %16.16e: %s", [_y minErrF], mpq_get_str(NULL, 10, *[_y minErr]), [_y maxErrF], mpq_get_str(NULL, 10, *[_y maxErr]));
...
-(void) propagate
{
    ...
    do {
        ...
        mpq_canonicalize(mpri_lepref(eoi));
        mpq_canonicalize(mpri_repref(eoi));
