...
void ulp_computation_f(ri* ulp, const float_interval f){
    ...
    if(f.inf == -INFINITY || f.sup == INFINITY){
        ...
        rational_set_d(&tmp0, nextafterf(DBL_MAX, -INFINITY) - DBL_MAX);
        rational_set_d(&tmp1, 2.0);
...
-(void) propagate
{
    ...
    //NSLog(@"x %16.16e: %s %16.16e: %s", [_x minErrF], rational_get_str(*[_x minErr])
    //      , [_x maxErrF], rational_get_str(*[_x maxErr]));
    //NSLog(@"y %16.16e: %s %16.16e: %s", [_y minErrF], rational_get_str(*[_y minErr]), [_y maxErrF], rational_get_str(*[_y maxErr]));
   ...
   max = [eo max];
    ...
    do {
        ...
        /*traceQP(printf("================== ADD in 1\nx    = [% 20.20e, % 20.20e], ex   = [% 20.20e, % 20.20e] %s\ny    = [% 20.20e, % 20.20e], ey   = [% 20.20e, % 20.20e] %s\nz    = [% 20.20e, % 20.20e], ez   = [% 20.20e, % 20.20e] %s\neo   = [% 20.20e, % 20.20e] %s\n",
                       x.inf, x.sup, rational_get_d((exi->inf)), rational_get_d((exi->sup)), (rational_cmp((exi->inf), (exi->sup)) > 0)?"empty":"",
                       y.inf, y.sup, rational_get_d((eyi->inf)), rational_get_d((eyi->sup)), (rational_cmp((eyi->inf), (eyi->sup)) > 0)?"empty":"",
                       z.inf, z.sup, rational_get_d((ezi->inf)), rational_get_d((ezi->sup)), (rational_cmp((ezi->inf), (ezi->sup)) > 0)?"empty":"",
                       rational_get_d((eoi->inf)), rational_get_d((eoi->sup)), (rational_cmp((eoi->inf), (eoi->sup)) > 0)?"empty":""));*/
        // ============================== ez
        // ex + ey + eo
        ri_add(&tmp0, &exi, &eyi);
        ...
        /*traceQP(printf("================== ADD in 2\nx    = [% 20.20e, % 20.20e], ex   = [% 20.20e, % 20.20e] %s\ny    = [% 20.20e, % 20.20e], ey   = [% 20.20e, % 20.20e] %s\nz    = [% 20.20e, % 20.20e], ez   = [% 20.20e, % 20.20e] %s\neo   = [% 20.20e, % 20.20e] %s\ntmp1 = [% 20.20e, % 20.20e]\n",
                       ...
                       z.inf, z.sup, rational_get_d((ezi->inf)), rational_get_d((ezi->sup)), (rational_cmp((ezi->inf), (ezi->sup)) > 0)?"empty":"",
                       rational_get_d((eoi->inf)), rational_get_d((eoi->sup)), (rational_cmp((eoi->inf), (eoi->sup)) > 0)?"empty":"",
                       rational_get_d((tmp1->inf)), rational_get_d((tmp1->sup))));*/
    ...
    /*traceQP(printf("================== ADD END\nx    = [% 20.20e, % 20.20e], ex   = [% 20.20e, % 20.20e]\ny    = [% 20.20e, % 20.20e], ey   = [% 20.20e, % 20.20e]\nz    = [% 20.20e, % 20.20e], ez   = [% 20.20e, % 20.20e]\neo   = [% 20.20e, % 20.20e]\n",
                   x.inf, x.sup, rational_get_d((exi->inf)), rational_get_d((exi->inf)),
                   y.inf, y.sup, rational_get_d((eyi->inf)), rational_get_d((eyi->inf)),
                   z.inf, z.sup, rational_get_d((ezi->inf)), rational_get_d((ezi->inf)),
