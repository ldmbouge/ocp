...
__attribute__((noinline))
void analyzeConflictUIP(CPLearningEngineI* engine, CPBitAssignment* conflict, CPCoreConstraint* constraint)
{
...
//   NSLog(@"%@",c);
   ...
   else if ([conflict->var getLevelBitWasSet:conflict->index] != -1)
   {
...
//               }
               ...
               if ([[var engine] isKindOfClass:[CPLearningEngineI class]]) {
                  ...
                  if(![var isFree:a->index])
                     ...
                     a->value = 0;
                  analyzeConflictUIP((CPLearningEngineI*)[var engine], a, constraint);
               }
//               NSLog(@"");
...
//         ORBool val;
//         ORUInt maxLevel = 5;
//         ORUInt currLevel = [[_assignments->antecedents[0]->var engine] getLevel];
//         CPBitVarI* var = NULL;
//         for(int i=0;i<numVars;i++){
...
-(void) post
{
   ...
   [engine addInternal: [[CPBitMultiply alloc] initCPBitMultiply:_y times:_q equals:_product]];
   
   [engine addInternal:[[CPBitADD alloc] initCPBitAdd:(CPBitVarI*)_product
                                                 plus:(CPBitVarI*)_r
                                               equals:(CPBitVarI*)_x
                                          withCarryIn:(CPBitVarI*)_cin
                                          andCarryOut:(CPBitVarI*)_cout]];
