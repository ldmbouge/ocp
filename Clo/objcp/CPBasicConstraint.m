...
-(id) initCPEqualBC: (CPIntVarBase*) x and: (CPIntVarBase*) y  and: (ORInt) c
{
   self = [super initCPCoreConstraint: [x engine]];
   _x = x;
   _y = y;
...
-(id) initCPEqualDC: (CPIntVarBase*) x and: (CPIntVarBase*) y  and: (ORInt) c
{
   self = [super initCPCoreConstraint:[x engine]];
   _x = x;
   _y = y;
...
-(id)initCPAffineBC:(CPIntVarBase*)y equal:(ORInt)a times:(CPIntVarBase*)x plus:(ORInt)b
{
...
-(id)initCPAffineAC:(CPIntVarBase*)y equal:(ORInt)a times:(CPIntVarBase*)x plus:(ORInt)b
{
   self = [super initCPCoreConstraint:[y engine]];
   _x = x;
   _y = y;
...
-(id) initCPEqual3BC: (CPIntVarBase*) x plus: (CPIntVarBase*) y  equal: (CPIntVarBase*) z
{
   self = [super initCPCoreConstraint:[x engine]];
   _x = x;
   _y = y;
...
-(id) initCPEqual3DC: (CPIntVarBase*) x plus: (CPIntVarBase*) y  equal: (CPIntVarBase*) z
{
   self = [super initCPCoreConstraint:[x engine]];
   _x = x;
   _y = y;
...
static inline TRIntArray createSupport(CPIntVarBase* v)
{
   return makeTRIntArray([[v engine] trail], [v max] - [v min] + 1, [v min]);
}
static ORStatus constAddScanB(ORInt a,CPBitDom* bd,CPBitDom* cd,CPIntVarBase* c,TRIntArray cs) // a + D(b) IN D(c)
{   
...
static ORStatus constSubScanB(ORInt a,CPBitDom* bd,CPBitDom* cd,CPIntVarBase* c,TRIntArray cs) // a - D(b) IN D(c)
{
   ORInt min = minCPDom(bd),max = maxCPDom(bd);
   for(ORInt j=min;j<=max;j++) {
      if (!getCPDom(bd,j)) continue;
...
static ORStatus scanASubConstB(CPBitDom* ad,ORInt b,CPBitDom* cd,CPIntVarBase* c,TRIntArray cs)  // D(a) - b IN D(c)
{
...
-(ORStatus)pruneVar:(CPIntVarBase*) v flat:(CPBitDom*) vd support:(TRIntArray) vs
{
...
-(id)initCPNotEqual:(CPIntVarBase*) x and:(CPIntVarBase*) y  and: (ORInt) c
{
   self = [super initCPCoreConstraint:[x engine]];
   _x = x;
   _y = y;
...
-(id) initCPLEqualBC:(CPIntVarBase*)x and:(CPIntVarBase*) y plus:(ORInt) c
{
   self = [super initCPCoreConstraint:[x engine]];
   _x = x;
   _y = y;
...
-(id)initCPAndDC:(CPIntVarBase*)b equal:(id<CPIntVar>) x and: (id<CPIntVar>) y
{
   self = [super initCPCoreConstraint:[b engine]];
   _b = (CPIntVarBase*) b;
   _x = (CPIntVarBase*) x;
...
static ORStatus propagateRXC(CPMultBC* mc,ORBounds r,CPIntVarBase* x,ORInt c)
{
...
-(void) propagateCXZ:(ORLong)c mult:(CPIntVarBase*)x equal:(ORBounds)zb
{
   int nz = ![_z member:0];
...
-(ORStatus) postCX:(ORLong)c mult:(CPIntVarBase*)x equal:(CPIntVarBase*)z
{
   if ([x bound])
...
static ORStatus propagateCX(CPMultBC* mc,ORLong c,CPIntVarBase* x,CPIntVarBase* z)
{
   if ([x bound]) {
      [z bind:bindDown(c * [x min])];
   }
...
-(void) propagateXCR:(CPIntVarBase*)x mult:(CPIntVarBase*)y equal:(ORBounds)r
{
   ORInt a = r.min,b=r.max;
...
-(id)initCPSquareBC:(CPIntVarBase*)z equalSquare:(CPIntVarBase*)x
{
   self = [super initCPCoreConstraint:[x engine]];
   _x = x;
   _z = z;
...
-(id)initCPModcBC:(CPIntVarBase*)x mod:(ORInt)c equal:(CPIntVarBase*)y
{
   self = [super initCPCoreConstraint: [x engine]];
   _x = x;
   _y = y;
...
-(id)initCPModcDC:(CPIntVarBase*)x mod:(ORInt)c equal:(CPIntVarBase*)y
{
   self = [super initCPCoreConstraint: [x engine]];
   _x = x;
   _y = y;
...
-(id)initCPModBC:(CPIntVarBase*)x mod:(CPIntVarBase*)y equal:(CPIntVarBase*)z
{
   self = [super initCPCoreConstraint: [x engine]];
   _x = x;
   _y = y;
...
-(id)initCPMin:(CPIntVarBase*)x and:(CPIntVarBase*)y equal:(CPIntVarBase*)z
{
   self = [super initCPCoreConstraint: [x engine]];
   _x = x;
   _y = y;
...
-(id)initCPMax:(CPIntVarBase*)x and:(CPIntVarBase*)y equal:(CPIntVarBase*)z
{
   self = [super initCPCoreConstraint: [x engine]];
   _x = x;
   _y = y;
...
-(CPIntVarMinimize*) init: (CPIntVarBase*) x
{
   self = [super initCPCoreConstraint:[x engine]];
   _x = x;
   _primalBound = MAXINT;
...
-(CPIntVarMaximize*) init: (CPIntVarBase*) x
{
   self = [super initCPCoreConstraint:[x engine]];
   _x = x;
   _primalBound = -MAXINT;
...
-(ORStatus) post
{
   ...
   if ([_cv[0] isKindOfClass:[CPIntVarI class]]) {
      for(NSUInteger i = 0; i < nb; i++) {
         CPIntVarBase* x = (CPIntVarBase*) _cv[i];
         // NSLog(@"x: %@",x);
         [x whenChangeBoundsPropagate: self];
