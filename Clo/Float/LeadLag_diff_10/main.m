...
int main(int argc, const char * argv[]) {
   /*
    1: Logic
    2: Disjunctive, combined
    3: Disjunctive, separated ifs
    4: Guarded, combined
...
//      [toadd addObject:[y set:@(4.00057888031005859375e+00f)]];
      ...
      [toadd addObject:[diff set: [u_opt[NBLOOPS] sub: u[NBLOOPS]]]];
      [toadd addObject:[[diff mul: diff] geq:@(5.0e-8f)]];
...
int main4(int argc, const char * argv[]) { // Disjunctive, combined
   @autoreleasepool {
      ORCmdLineArgs* args = [ORCmdLineArgs newWith:argc argv:argv];
