...
int main(int argc, const char * argv[]) {
   @autoreleasepool {
      ORCmdLineArgs* args = [ORCmdLineArgs newWith:argc argv:argv];
         ...
         id<ORFloatVar> a = [ORFactory floatVar:model low:-100000.0 up:100000.0 name:@"a"];
         id<ORFloatVar> b = [ORFactory floatVar:model low:-100000.0 up:100000.0 name:@"b"];
         id<ORFloatVar> c = [ORFactory floatVar:model low:-100000.0 up:100000.0 name:@"c"];
