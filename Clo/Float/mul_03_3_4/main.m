...
int main(int argc, const char * argv[]) {
   @autoreleasepool {
      ORCmdLineArgs* args = [ORCmdLineArgs newWith:argc argv:argv];
         ...
         id<ORFloatVar> a = [ORFactory floatVar:model low:-1000000.0 up:1000000.0 name:@"a"];
         id<ORFloatVar> b = [ORFactory floatVar:model low:-1000000.0 up:1000000.0 name:@"b"];
         id<ORFloatVar> c = [ORFactory floatVar:model low:-1000000.0 up:1000000.0 name:@"c"];
         ...
         id<ORExpr> epsilon =  [ORFactory float:model value:3.f];
