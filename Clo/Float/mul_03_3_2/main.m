...
int main(int argc, const char * argv[]) {
   @autoreleasepool {
      ...
      [args measure:^struct ORResult(){
         ...
         id<ORFloatVar> a = [ORFactory floatVar:model low:-10000.0f up:10000.0f name:@"a"];
         id<ORFloatVar> b = [ORFactory floatVar:model low:-10000.0f up:10000.0f name:@"b"];
         id<ORFloatVar> c = [ORFactory floatVar:model low:-10000.0f up:10000.0f name:@"c"];
