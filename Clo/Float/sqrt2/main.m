...
int main(int argc, const char * argv[]) {
   @autoreleasepool {
      ...
      [args measure:^struct ORResult(){
         ...
         [model add:[xf018 eq:[xf016 toFloat]]];
         
         [model add:[xf020 eq:[xf014 plus:[[xf016 div:[b55 mul:[xf014 toDouble]]] toFloat]]]];
         [model add:[xf022 eq:[[[b39 plus:[[xf020 mul:xf020] minus]] toDouble] toFloat]]];
         
         [model add:[xf024 eq:[b106 toFloat]]];
...
//         [model add:[b189 neq:@(0.0)]];
         ...
         [model add:[[b46 leq:xf018] neg]];
         [model add:[[b46 leq:xf022] neg]];
         [model add:[[b46 leq:xf024] neg]];
