...
//     max[3] = 0xFFFFFF00;
     ...
     id<CPBitVar> x = [CPFactory bitVar:m withLow: min andUp:max andLength:32];
...
//   max[3] = 0xFFFFFFFF;
   ...
   id<CPBitVar> y = [CPFactory bitVar:m withLow: min andUp:max andLength:32];
//     
//     min[0] = 0x0F003C00;//
//     min[1] = 0x1FC003C0;
//     min[2] = 0x078003F0;
...
//   max[3] = 0xFFFFFFFF;
   ...
   min[1] = 0x00000000;
     ...
     id<CPBitVar> ci = [CPFactory bitVar:m withLow: min andUp:max andLength:32];
...
//   max[3] = 0xFFFFFFFF;
   ...
   id<CPBitVar> z = [CPFactory bitVar:m withLow: min andUp:max andLength:32];
...
//     max[3] = 0xB575B500;
   ...
   id<CPBitVar> co = [CPFactory bitVar:m withLow: min andUp:max andLength:32];
/*
    NSLog(@"x    = %@\n", x);
    NSLog(@"y    = %@\n", y);
    NSLog(@"cin  = %@\n", ci);
