...
+(id<ORConstraint>) realMult:(id<ORTracker>)model  var: (id<ORRealVar>)x by:(id<ORRealVar>)y equal:(id<ORRealVar>)z;
...
+(id<ORConstraint>) realEqual:(id<ORTracker>)model var:(id<ORRealVar>)x to:(id<ORRealVar>)y;
