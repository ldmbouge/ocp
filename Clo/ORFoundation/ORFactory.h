...
+(id<ORConstraint>) ExactMDDMISP:(id<ORTracker>)model  var: (id<ORIntVarArray>)x reduced:(bool)reduced adjacencies:(bool* _Nonnull)adjacencyMatrix vertexValues:(int* _Nonnull)vertexValues;
