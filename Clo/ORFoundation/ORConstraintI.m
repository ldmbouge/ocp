...
@implementation ORRationalLEqualc {
   id<ORRationalVar> _x;
   id<ORRational>        _c;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
   [super encodeWithCoder:aCoder];
   [aCoder encodeObject:_x];
   [aCoder encodeValueOfObjCType:@encode(ORRational) at:&_c];
}
- (id)initWithCoder:(NSCoder *)aDecoder
{
   self = [super initWithCoder:aDecoder];
...
@implementation ORRationalUlpOf {
   id<ORVar> _x;
   id<ORRationalVar> _y;
}
-(id)initORRationalUlpOf:(id<ORVar>)x is:(id<ORRationalVar>)y
{
   self = [super initORConstraintI];
   _x = x;
   _y = y;
...
{
   NSMutableString* buf = [[[NSMutableString alloc] initWithCapacity:64] autorelease];
   [buf appendFormat:@"<%@ : %p> -> (ulp(%@) == %@)",[self class],self,_x,_y];
   return buf;
}
-(void)visit:(ORVisitor*)v
{
   [v visitRationalUlpOf:self];
}
-(id<ORVar>) left
{
   return _x;
...
@implementation ORDoubleLEqualc {
   id<ORDoubleVar> _x;
   ORDouble        _c;
}
...
@implementation ORDoubleGEqualc {
   id<ORDoubleVar> _x;
   ORDouble        _c;
}
...
-(ORFloatAssignC*)initORFloatAssignC:(id<ORFloatVar>)x to:(ORFloat)c
{
   self = [super initORConstraintI];
   _x = x;
   _c = c;
...
@implementation ORFloatAssign { // x = y
   id<ORVar> _x;
   id<ORVar> _y;
}
-(ORFloatAssign*)initORFloatAssign:(id<ORVar>)x to:(id<ORVar>)y
{
   self = [super initORConstraintI];
   _x = x;
   _y = y;
...
@implementation ORRationalAssign { // x = y
   id<ORVar> _x;
   id<ORVar> _y;
}
-(ORRationalAssign*)initORRationalAssign:(id<ORVar>)x to:(id<ORVar>)y
{
   self = [super initORConstraintI];
   _x = x;
   _y = y;
...
@implementation ORRationalDiv { // x = y * z
   id<ORVar> _x;
   id<ORVar> _y;
   id<ORVar> _z;
}
...
@implementation ORFloatReifyEqualc {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   ORFloat        _c;
}
...
@implementation ORFloatReifyEqual {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   id<ORFloatVar> _y;
}
...
@implementation ORFloatReifyNEqual {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   id<ORFloatVar> _y;
}
...
@implementation ORFloatReifyLEqualc {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   ORFloat        _c;
}
-(ORFloatReifyLEqualc*)initFloatReify:(id<ORIntVar>)b equiv:(id<ORFloatVar>)x leqi:(ORFloat)c
{
   self = [super initORConstraintI];
   _b = b;
   _x = x;
...
@implementation ORFloatReifyLEqual {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   id<ORFloatVar> _y;
}
...
@implementation ORFloatReifyLThen {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   id<ORFloatVar> _y;
}
...
@implementation ORFloatReifyLThenc {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   ORFloat        _c;
}
-(ORFloatReifyLThenc*)initFloatReify:(id<ORIntVar>)b equiv:(id<ORFloatVar>)x lti:(ORFloat)c
{
   self = [super initORConstraintI];
   _b = b;
   _x = x;
...
@implementation ORFloatReifyGEqualc {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   ORFloat        _c;
}
-(ORFloatReifyGEqualc*)initFloatReify:(id<ORIntVar>)b equiv:(id<ORFloatVar>)x geqi:(ORFloat)c
{
   self = [super initORConstraintI];
   _b = b;
   _x = x;
...
@implementation ORFloatReifyGEqual {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   id<ORFloatVar> _y;
}
...
@implementation ORFloatReifyGThen {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   id<ORFloatVar> _y;
}
...
@implementation ORFloatReifyGThenc {
   id<ORIntVar> _b;
   id<ORFloatVar> _x;
   ORFloat        _c;
}
-(ORFloatReifyGThenc*)initFloatReify:(id<ORIntVar>)b equiv:(id<ORFloatVar>)x gti:(ORFloat)c
{
   self = [super initORConstraintI];
   _b = b;
   _x = x;
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyEqualc:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyNEqualc:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
@implementation ORRationalReifyEqual {
   id<ORIntVar> _b;
   id<ORRationalVar> _x;
   id<ORRationalVar> _y;
}
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyEqual:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
@implementation ORRationalReifyNEqual {
   id<ORIntVar> _b;
   id<ORRationalVar> _x;
   id<ORRationalVar> _y;
}
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyNEqual:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyLEqualc:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
@implementation ORRationalReifyLEqual {
   id<ORIntVar> _b;
   id<ORRationalVar> _x;
   id<ORRationalVar> _y;
}
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyLEqual:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
@implementation ORRationalReifyLThen {
   id<ORIntVar> _b;
   id<ORRationalVar> _x;
   id<ORRationalVar> _y;
}
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyLThen:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyLThenc:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyGEqualc:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
@implementation ORRationalReifyGEqual {
   id<ORIntVar> _b;
   id<ORRationalVar> _x;
   id<ORRationalVar> _y;
}
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyGEqual:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
@implementation ORRationalReifyGThen {
   id<ORIntVar> _b;
   id<ORRationalVar> _x;
   id<ORRationalVar> _y;
}
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyGThen:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
-(void)visit:(ORVisitor*)v
{
   [v visitRationalReifyGThenc:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
@implementation ORDoubleReifyEqualc {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   ORDouble        _c;
}
...
-(void)visit:(ORVisitor*)v
{
   [v visitDoubleReifyNEqualc:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
@implementation ORDoubleReifyEqual {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   id<ORDoubleVar> _y;
}
...
@implementation ORDoubleReifyNEqual {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   id<ORDoubleVar> _y;
}
...
@implementation ORDoubleReifyLEqualc {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   ORDouble        _c;
}
-(ORDoubleReifyLEqualc*)initDoubleReify:(id<ORIntVar>)b equiv:(id<ORDoubleVar>)x leqi:(ORDouble)c
{
   self = [super initORConstraintI];
   _b = b;
   _x = x;
...
-(void)visit:(ORVisitor*)v
{
   [v visitDoubleReifyLEqualc:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
@implementation ORDoubleReifyLEqual {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   id<ORDoubleVar> _y;
}
...
@implementation ORDoubleReifyLThen {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   id<ORDoubleVar> _y;
}
...
@implementation ORDoubleReifyLThenc {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   ORDouble        _c;
}
-(ORDoubleReifyLThenc*)initDoubleReify:(id<ORIntVar>)b equiv:(id<ORDoubleVar>)x lti:(ORDouble)c
{
   self = [super initORConstraintI];
   _b = b;
   _x = x;
...
@implementation ORDoubleReifyGEqualc {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   ORDouble        _c;
}
-(ORDoubleReifyGEqualc*)initDoubleReify:(id<ORIntVar>)b equiv:(id<ORDoubleVar>)x geqi:(ORDouble)c
{
   self = [super initORConstraintI];
   _b = b;
   _x = x;
...
-(void)visit:(ORVisitor*)v
{
   [v visitDoubleReifyGEqualc:self];
}
-(id<ORIntVar>) b
{
   return _b;
...
@implementation ORDoubleReifyGEqual {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   id<ORDoubleVar> _y;
}
...
@implementation ORDoubleReifyGThen {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   id<ORDoubleVar> _y;
}
...
@implementation ORDoubleReifyGThenc {
   id<ORIntVar> _b;
   id<ORDoubleVar> _x;
   ORDouble        _c;
}
-(ORDoubleReifyGThenc*)initDoubleReify:(id<ORIntVar>)b equiv:(id<ORDoubleVar>)x gti:(ORDouble)c
{
   self = [super initORConstraintI];
   _b = b;
   _x = x;
