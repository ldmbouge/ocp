...
int main(int argc, const char * argv[])
{
   ...
   [benders run];
    ...
    ORLogicBenders* b = (ORLogicBenders*)benders;
    NSString* outstr = [NSString stringWithFormat: @"%f %f %f\n", b.timeInMaster, b.timeInSlave, totalTime];
    NSLog(outstr);
    //[outstr writeToFile: @"/Users/dan/Desktop/benders.txt" atomically:YES encoding: NSASCIIStringEncoding error: nil];
    FILE* f = fopen("/Users/dan/Desktop/benders.txt", "w+");
    fprintf(f, "%s", [outstr UTF8String]);
    fclose(f);
