...
static const char*  typeName[] = {"Bool","Int","Real","BitVec","FloatingPoint","Float32","Float64"};
static objcp_var_type  typeObj[] = {OR_BOOL, OR_INT, OR_REAL, OR_BV, OR_FLOAT,OR_FLOAT,OR_DOUBLE};
#define NB_TYPE 7
