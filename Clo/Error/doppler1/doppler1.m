...
void doppler1_d(int search, int argc, const char * argv[]) {
   @autoreleasepool {
      ...
      /* Compute value of ez for input values for u, v, and t */
      /*[mdl add:[u set:@(-9.99999999999999857891e+01)]];
       [mdl add:[v set:@(1.90264955549804508337e+04)]];
       [mdl add:[t set:@(-1.55069744002588549847e+01)]];*/
