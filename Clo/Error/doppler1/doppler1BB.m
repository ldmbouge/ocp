...
id<ORRational> (^doppler1Error)(NSMutableArray* arrayValue, NSMutableArray* arrayError) = ^(NSMutableArray* arrayValue, NSMutableArray* arrayError){
...
void doppler1_d(int search, int argc, const char * argv[]) {
   @autoreleasepool {
      ...
      id<ORDoubleVar> u = [ORFactory doubleInputVar:mdl low:-100.0 up:100.0 elow:zero eup:zero name:@"u"];
      id<ORDoubleVar> v = [ORFactory doubleInputVar:mdl low:20.0 up:20000.0 elow:zero eup:zero name:@"v"];
      id<ORDoubleVar> t = [ORFactory doubleInputVar:mdl low:-30.0 up:50.0 elow:zero eup:zero name:@"t"];
...
void doppler1_d_c_3B(int search, int argc, const char * argv[]) {
   @autoreleasepool {
      /* Creation of model */
      id<ORModel> mdl = [ORFactory createModel];
      id<ORRational> zero = [ORRational rationalWith_d:0.0];
