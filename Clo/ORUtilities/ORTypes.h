...
typedef void (^DDArcTransitionClosure)(char*,char*,char*,ORInt);
typedef void (^DDArcSetTransitionClosure)(char*,char*,char*,bool*, int, int);
typedef void (^DDUpdatePropertyClosure)(char*,char*,char*);
typedef bool (^DDStateExistsClosure)(char*,char*,char*,ORInt,ORInt);
typedef bool (^DDArcExistsClosure)(char*,char*,ORInt, ORInt, ORInt);
