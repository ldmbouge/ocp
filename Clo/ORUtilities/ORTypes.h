...
typedef long (^DDOldClosure)(char*,ORInt,ORInt);
typedef void (^DDArcTransitionClosure)(char*,char*,char*,ORInt,ORInt);
typedef void (^DDArcSetTransitionClosure)(char*,char*,char*,ORInt,id);
typedef bool (^DDArcExistsClosure)(char*,char*,ORInt,ORInt, ORInt, ORInt);
typedef long (^DDOldMergeClosure)(char*,char*,char*);
typedef void (^DDMergeClosure)(char*,char*,char*);
typedef int (^DDFixpointBoundClosure)(char*);
typedef long (^DDSlackClosure)(char*);
